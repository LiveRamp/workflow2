package com.liveramp.workflow2.workflow_ui;
...
import com.liveramp.workflow2.workflow_ui.servlet.AlertServlet;
import com.liveramp.workflow2.workflow_ui.servlet.AppCostHistoryServlet;
import com.liveramp.workflow2.workflow_ui.servlet.ApplicationListServlet;
import com.liveramp.workflow2.workflow_ui.servlet.ApplicationQueryServlet;
import com.liveramp.workflow2.workflow_ui.servlet.AttemptStateServlet;
import com.liveramp.workflow2.workflow_ui.servlet.AvailableNotificationServlet;
import com.liveramp.workflow2.workflow_ui.servlet.ClusterAppAlerts;
import com.liveramp.workflow2.workflow_ui.servlet.ClusterConstants;
import com.liveramp.workflow2.workflow_ui.servlet.ClusterUsageServlet;
import com.liveramp.workflow2.workflow_ui.servlet.CostServlet;
import com.liveramp.workflow2.workflow_ui.servlet.ExecutionQueryServlet;
import com.liveramp.workflow2.workflow_ui.servlet.HDFSIOServlet;
import com.liveramp.workflow2.workflow_ui.servlet.JSONServlet;
import com.liveramp.workflow2.workflow_ui.servlet.NameNodeUsageServlet;
import com.liveramp.workflow2.workflow_ui.servlet.PipelineServlet;
import com.liveramp.workflow2.workflow_ui.servlet.ShuffleIOServlet;
import com.liveramp.workflow2.workflow_ui.servlet.StatServlet;
import com.liveramp.workflow2.workflow_ui.servlet.TaskExceptionServlet;
import com.liveramp.workflow_db_state.ThreadLocalWorkflowDb;
import com.liveramp.workflow2.workflow_ui.servlet.command.AttemptCommandServlet;
import com.liveramp.workflow2.workflow_ui.servlet.command.DashboardServlet;
import com.liveramp.workflow2.workflow_ui.servlet.command.ExecutionCommandServlet;
import com.liveramp.workflow2.workflow_ui.servlet.command.NotificationConfigurationServlet;
import com.liveramp.workflow2.workflow_ui.servlet.command.UserConfigServlet;
import com.liveramp.workflow2.workflow_ui.util.dashboards.SeedDashboardTask;
import com.liveramp.workflow2.workflow_ui.util.prime.Prime;
import com.liveramp.workflow2.workflow_ui.util.prime.RequestBuilder;
import com.liveramp.workflow2.workflow_ui.util.prime.TimeIntervalBuilder;
...
public class WorkflowDbWebServer implements Runnable {
  ...
  public void run() {
    try {
      ...
      final URL warUrl = uiServer.getClass().getClassLoader().getResource("com/liveramp/workflow2/workflow_ui/www");
      ...
      annotation.setConfigLocation("com.liveramp.workflow2.workflow_ui.security");
